...
namespace CK.MQTT.Client.Abstractions.Tests
{
    class TestImpl : IMqttClient
    {
        ...
        public Task PublishAsync( IActivityMonitor m, string topic, ReadOnlyMemory<byte> payload, QualityOfService qos, bool retain = false )
        {
            throw new NotImplementedException();
        }
        ...
        public Task<SubscribeReturnCode[]> SubscribeAsync( IActivityMonitor m, string topicFilter, QualityOfService qos )
        {
            throw new NotImplementedException();
        }
    }
