        ...
        public async Task ExecuteAsync( string clientId, IPacket input, IMqttChannel<IPacket> channel )
        {
            ...
            foreach( Subscription subscription in subscribe.Subscriptions )
            {
                try
                {
                    ...
                    {
                        _tracer.Error( ServerProperties.Resources.GetString( "ServerSubscribeFlow_InvalidTopicSubscription" ), subscription.TopicFilter, clientId );
                ...
                {
                    _tracer.Error( repoEx, ServerProperties.Resources.GetString( "ServerSubscribeFlow_ErrorOnSubscription" ), clientId, subscription.TopicFilter );
