...
namespace CK.MQTT.Sdk
{
    ...
    public class MqttClientFactory
    {
        ...
        public async Task<IMqttClient> CreateClientAsync( IActivityMonitor m, MqttConfiguration configuration )
        {
            try
            {
            ...
            {
                m.Error( Properties.Client_InitializeError, ex );

                throw new MqttClientException( Properties.Client_InitializeError, ex );
            }
        }
    }
}
