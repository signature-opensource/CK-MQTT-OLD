...
namespace CK.MQTT.Sdk
{
    internal static class ByteExtensions
    {
        ...
        {
            if( bit > 7 )
                throw new ArgumentOutOfRangeException( nameof( bit ), Properties.Resources.GetString( "ByteExtensions_InvalidBitPosition" ) );
        ...
        {
            if( index < 1 || index > 8 )
                throw new ArgumentOutOfRangeException( nameof( index ), Properties.Resources.GetString( "ByteExtensions_InvalidByteIndex" ) );
