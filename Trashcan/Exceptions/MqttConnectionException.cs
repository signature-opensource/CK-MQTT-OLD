...
namespace CK.MQTT
{
    ...
    public class MqttConnectionException : MqttException
    {
        ...
        /// See <see cref="ConnectionStatus" /> for more information about the possible connection status values 
        /// </param>
        public MqttConnectionException( ConnectionStatus status ) : base( status.ToString() )
        {
            ReturnCode = status;
        }
