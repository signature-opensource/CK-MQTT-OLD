...
namespace CK.MQTT
{
    public static class ClientProperties
    {
        ...
        public static string Client_ConnectNotAccepted( string clientId, ConnectionStatus status ) => $"The connect packet of client {clientId} has not been accepted by the server. Status: {status}. The connection will be closed";
